<div align="center">
  ...
  <br/>
  <p>Αρχικοποιούμε κάθε κόμβο του πίνακα με την τιμή άπειρο και διαλέγουμε τον αρχικό μας κόμβο.</p>
  <hr />

  <img src="./img/Slide8.png">
  <br/>
  <p>Σε αυτό το παράδειγμα θα επιλέξουμε τον κόμβο <strong><em>s</em></strong>.</p>
  <hr />
